...
const Hero = () => {
  return (
    <div className='bg-base-200 flex justify-center items-center py-5 px-5 md:px-10 md:py-10 lg:px-0 lg:py-0'>
        <div className='md:w-3/7 hidden md:block'><img src={heroIcon} alt="" /></div>
        <div className='md:w-4/7 text-center md:text-start'>
            <h1 className='font-extrabold text-2xl md:text-4xl'>WELCOME</h1>
            <p className='text-2xl md:text-6xl font-bold'>To <br className='block md:hidden'/> <span className='text-secondary text-4xl md:text-6xl'>FunVille <span className='text-primary'>Toys</span></span></p>
            <p className='md:w-2/3 mt-5'>
