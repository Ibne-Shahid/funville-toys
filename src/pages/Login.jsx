        ...
        <div className='flex justify-center py-20'>
            ...
            <div className='fieldset bg-base-300 border-base-300 rounded-box w-xs border p-4'>
                <form onSubmit={handleSignIn}>
                    ...
                    <button type="submit" className="btn btn-accent w-full text-white mt-3">Login</button>
                    ...
                    <p className='mt-3'>Doesn't have an account? <Link to="/register" state={location.state}><span className='text-secondary'>Register</span></Link></p>
                </form>
            </div>
        </div>
    )
