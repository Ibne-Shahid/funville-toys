        ...
        <div>
            <div>
                <div className='py-20 px-2'>
                    ...
                    <p className='text-5xl text-red-700 text-center font-bold'>Toy Not Found</p>
                    <p className='text-center text-[#627382] mt-3'>The Toy you are looking for doesn't exist or has been removed!</p>
